...
export default function MyService() {
    ...
    const checkedService = (cls, rootchecked) => {
        cls.forEach((serviceDoc, index) => {
            ...
            console.log("serviceDoc.value",serviceDoc.value,rootchecked,serviceDoc.getAttribute('id'))
    ...
    const changeFacility = (id, checked) => {
        ...
        console.log("totalChecked:", servBox[0], checked,servBox);
        let totalChecked = document.querySelectorAll(`.${servBox[0]}:checked`);
        if (totalChecked.length === 1) {
        ...
        console.log("totalChecked:", totalChecked.length, servBox[0]);
    }
    const changeRoot = (e) => {
