...
// console.log('KTUtil_function', KTUtil)
// Webpack support
...
// Declare KTApp for Webpack support
if (typeof module !== 'undefined' && typeof module.exports !== 'undefined') {
    console.log('Declare KTApp for Webpack support')
...
var KTDrawer = function (element, options) {
    ...
    console.log('KTEventHandler', KTEventHandler)


    var _show = function () {
        console.log('show_KTEventHandler', KTEventHandler)
    ...
    var _hide = function () {
        console.log('KTEventHandler 2854:', KTEventHandler)
    ...
    var _update = function () {
        ...
        if (_getOption('activate') === true) {
            ...
            // custom function call by adesh
            if (document.contains(document.querySelector('.drawer-on'))) {
                _hide();
            }
            // default function calll
            /* _hide(); */
        }
    }
    ...
    the.hide = function () {
        console.log("trigger 3034", the.hide)
        return _hide();
    }
    ...
    the.trigger = function (name, event) {
        console.log("trigger 3066", the.trigger)
        return KTEventHandler.trigger(the.element, name, event, the, event);
    }
};
...
KTDrawer.createInstances = function (selector = '[data-kt-drawer="true"]') {
    ...
    if (elements && elements.length > 0) {
        console.log('elements 3128:', elements)
        for (var i = 0, len = elements.length; i < len; i++) {
...
var KTThemeModeUser = function () {
    console.log('KTThemeModeUser:7805')
