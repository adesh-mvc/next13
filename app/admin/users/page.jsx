    ...
    return (
        <>
            ...
            " style={{ width: '29.8906px' }}>
                                    ...
                                    <tr className="odd">
                                        ...
                                        <td className="d-flex align-items-center">
                                            ...
                                            <div className="d-flex flex-column">
                                                <a href="view.html" className="text-gray-800 text-hover-primary mb-1">John Miller</a>
                                        ...
                                        <td className="d-flex align-items-center">
                                            ...
                                            {/*begin::User details*/}
                                            <div className="d-flex flex-column">
                                                <a href="view.html" className="text-gray-800 text-hover-primary mb-1">Francis Mitcham</a>
                                        ...
                                        {/*end::Two step-*/}
                                        {/*begin::Joined*/}
                                        <td data-order="2023-11-10T14:40:00+05:30">
                                        ...
                                        {/*end::Two step-*/}
                                        {/*begin::Joined*/}
                                        <td data-order="2023-03-10T18:05:00+05:30">
                                        ...
                                        <td className="d-flex align-items-center">
                                            ...
                                            {/*begin::User details*/}
                                            <div className="d-flex flex-column">
                                                <a href="view.html" className="text-gray-800 text-hover-primary mb-1">Emma Bold</a>
                                        ...
                                        {/*end::Role-*/}
                                        {/*begin::Last login-*/}
                                        <td data-order="2023-03-03T13:28:33+05:30" className>
                                        ...
                                        {/*end::Two step-*/}
                                        {/*begin::Joined*/}
                                        <td data-order="2023-10-25T14:40:00+05:30">
                                        ...
                                        <td className="d-flex align-items-center">
                                            ...
                                            {/*begin::User details*/}
                                            <div className="d-flex flex-column">
                                                <a href="view.html" className="text-gray-800 text-hover-primary mb-1">Sean Bean</a>
                                        ...
                                        {/*end::Two step-*/}
                                        {/*begin::Joined*/}
                                        <td data-order="2023-04-15T14:40:00+05:30">
                                        ...
                                        {/*end::Two step-*/}
                                        {/*begin::Joined*/}
                                        <td data-order="2023-07-25T17:20:00+05:30">
                                        ...
                                        <td className="d-flex align-items-center">
                                            ...
                                            {/*begin::User details*/}
                                            <div className="d-flex flex-column">
                                                <a href="view.html" className="text-gray-800 text-hover-primary mb-1">Max Smith</a>
                                        ...
                                        {/*end::Role-*/}
                                        {/*begin::Last login-*/}
                                        <td data-order="2023-02-28T18:28:33+05:30" className>
                                        ...
                                        {/*end::Two step-*/}
                                        {/*begin::Joined*/}
                                        <td data-order="2023-06-24T14:40:00+05:30">
                                        ...
                                        {/*end::Two step-*/}
                                        {/*begin::Joined*/}
                                        <td data-order="2023-02-21T11:05:00+05:30">
                                        ...
                                        <td className="d-flex align-items-center">
                                            ...
                                            {/*begin::User details*/}
                                            <div className="d-flex flex-column">
                                                <a href="view.html" className="text-gray-800 text-hover-primary mb-1">Dan Wilson</a>
                                        ...
                                        {/*end::Two step-*/}
                                        {/*begin::Joined*/}
                                        <td data-order="2023-06-24T17:30:00+05:30">
                                        ...
                                        <td className="d-flex align-items-center">
                                            ...
                                            {/*begin::User details*/}
                                            <div className="d-flex flex-column">
                                                <a href="view.html" className="text-gray-800 text-hover-primary mb-1">Brian Cox</a>
                                        ...
                                        {/*end::Role-*/}
                                        {/*begin::Last login-*/}
                                        <td data-order="2023-03-01T18:28:33+05:30" className>
                                        ...
                                        {/*end::Two step-*/}
                                        {/*begin::Joined*/}
                                        <td data-order="2023-04-15T22:10:00+05:30">
                                ...
                                {/*end::Table body*/}
                            </table></div><div className="row"><div className="col-sm-12 col-md-5 d-flex align-items-center justify-content-center justify-content-md-start" /><div className="col-sm-12 col-md-7 d-flex align-items-center justify-content-center justify-content-md-end"><div className="dataTables_paginate paging_simple_numbers" id="kt_table_users_paginate"><ul className="pagination"><li className="paginate_button page-item previous disabled" id="kt_table_users_previous"><a href="#" aria-controls="kt_table_users" data-dt-idx={0} tabIndex={0} className="page-link"><i className="previous" /></a></li><li className="paginate_button page-item active"><a href="#" aria-controls="kt_table_users" data-dt-idx={1} tabIndex={0} className="page-link">1</a></li><li className="paginate_button page-item "><a href="#" aria-controls="kt_table_users" data-dt-idx={2} tabIndex={0} className="page-link">2</a></li><li className="paginate_button page-item "><a href="#" aria-controls="kt_table_users" data-dt-idx={3} tabIndex={0} className="page-link">3</a></li><li className="paginate_button page-item next" id="kt_table_users_next"><a href="#" aria-controls="kt_table_users" data-dt-idx={4} tabIndex={0} className="page-link"><i className="next" /></a></li></ul></div></div></div></div>
                            {/*end::Table*/}  </div>
                        {/*end::Card body*/}
                    </div>
                    {/*end::Card*/}					</div>
